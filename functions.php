...
function menu()
{
    ...
    if ($_SESSION['kanri_flg']==1) {
        $menu .= '<li class="nav-item"><a class="nav-link" href="user_select.php">user管理</a></li><li class="nav-item"><a class="nav-link" href="user_index.php">user登録</a></li>';
    }
